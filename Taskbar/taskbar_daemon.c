...
int main(int argc, char *argv[])
{
    ...
    while(1)
    {
        ...
        if(gpssat[0]=='G')
        {
            ...
            if(system("pidof -x gpsd > /dev/null")!=0)
            {
        ...
        if(charger_notify==0){
            ...
            if(bat_Temp<=tmp_bat){
                if(bat_Temp<100 && bat_Temp>=89){
                ...
                else if(bat_Temp<=88 && bat_Temp>=86) {
                    leve4_count++;
                ...
                else if(bat_Temp<=81 && bat_Temp>=80) {
                    leve2_count++;
                ...
                else if(bat_Temp<=79 && bat_Temp>=78) {
                    leve1_count++;
                    ...
                    if(low_bat_count>=10) {
                        system("touch /usr/share/status/low_battery");
        ...
        *s = '\0';
        ...
        if(system("pidof -x netd > /dev/null")!=0){
        ...
        if(system("pidof -x startApplication > /dev/null")!=0){
	    //system("echo 1 > /dev/fbrefresh0");
            system("sh /usr/share/scripts/bootapp.sh");
            	usleep(1000000);
        }
	if(system("pidof -x standbyd > /dev/null")!=0){
	    system("killall standbyd");
            system("/opt/daemon_files/standbyd -d");
            usleep(1000000);
        }
    }
}
