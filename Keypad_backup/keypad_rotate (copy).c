...
void check_status(void)
{
    ...
    if( access( "/usr/share/status/Numeric_status", F_OK ) != -1 ) {
        ...
        system("rm /usr/share/status/Numeric_status; echo 3 > /usr/share/status/KEYPAD_mode;");
    }
    if( access( "/usr/share/status/Asmall_status", F_OK ) != -1 ) {
        task_bar_status[0]=0x31;
        system("rm /usr/share/status/Asmall_status; echo 1 > /usr/share/status/KEYPAD_mode;");
    }
}
